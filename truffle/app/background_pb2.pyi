...
class BackgroundApp(_message.Message):
    __slots__ = ("runtime_policy", "settings")
    ...
    settings: BackgroundApp.Settings
    def __init__(self, runtime_policy: _Optional[_Union[BackgroundAppRuntimePolicy, _Mapping]] = ..., settings: _Optional[_Union[BackgroundApp.Settings, _Mapping]] = ...) -> None: ...
