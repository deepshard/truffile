...
class AppInstallSource(_message.Message):
    __slots__ = ("source_type", "url", "git_hash", "release")
    ...
    url: str
    git_hash: str
    release: _app_pb2.AppBundleRelease
    def __init__(self, source_type: _Optional[_Union[AppInstallSourceType, str]] = ..., url: _Optional[str] = ..., git_hash: _Optional[str] = ..., release: _Optional[_Union[_app_pb2.AppBundleRelease, _Mapping]] = ...) -> None: ...
...
class AppInstallModal(_message.Message):
    ...
    class VNCModal(_message.Message):
        __slots__ = ("instructions", "vnc_uri_path", "closes_on_complete", "display_url", "favicon_url")
        INSTRUCTIONS_FIELD_NUMBER: _ClassVar[int]
        ...
        display_url: str
        favicon_url: str
        def __init__(self, instructions: _Optional[str] = ..., vnc_uri_path: _Optional[str] = ..., closes_on_complete: bool = ..., display_url: _Optional[str] = ..., favicon_url: _Optional[str] = ...) -> None: ...
...
class AppInstallRequest(_message.Message):
    __slots__ = ("start_new", "start_update", "user_action")
    class StartNewInstall(_message.Message):
        __slots__ = ("source", "replace_app_uuid")
        SOURCE_FIELD_NUMBER: _ClassVar[int]
        REPLACE_APP_UUID_FIELD_NUMBER: _ClassVar[int]
        source: AppInstallSource
        replace_app_uuid: str
        def __init__(self, source: _Optional[_Union[AppInstallSource, _Mapping]] = ..., replace_app_uuid: _Optional[str] = ...) -> None: ...
    class StartUpdate(_message.Message):
        __slots__ = ("app_uuid", "source")
        APP_UUID_FIELD_NUMBER: _ClassVar[int]
        SOURCE_FIELD_NUMBER: _ClassVar[int]
        app_uuid: str
        source: AppInstallSource
        def __init__(self, app_uuid: _Optional[str] = ..., source: _Optional[_Union[AppInstallSource, _Mapping]] = ...) -> None: ...
    START_NEW_FIELD_NUMBER: _ClassVar[int]
    START_UPDATE_FIELD_NUMBER: _ClassVar[int]
    USER_ACTION_FIELD_NUMBER: _ClassVar[int]
    start_new: AppInstallRequest.StartNewInstall
    start_update: AppInstallRequest.StartUpdate
    user_action: AppInstallUserAction
    def __init__(self, start_new: _Optional[_Union[AppInstallRequest.StartNewInstall, _Mapping]] = ..., start_update: _Optional[_Union[AppInstallRequest.StartUpdate, _Mapping]] = ..., user_action: _Optional[_Union[AppInstallUserAction, _Mapping]] = ...) -> None: ...
