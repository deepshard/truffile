...
class ProactiveAction(_message.Message):
    __slots__ = ("task_id", "title", "description", "actionable", "status", "created_at", "updated_at", "app_uuids", "prompt_for_subagent")
    class Status(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        ACTION_STATE_FAILED: _ClassVar[ProactiveAction.Status]
        ACTION_IS_TASK: _ClassVar[ProactiveAction.Status]
    ...
    ACTION_STATE_FAILED: ProactiveAction.Status
    ACTION_IS_TASK: ProactiveAction.Status
    ...
    def __init__(self, task_id: _Optional[str] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., actionable: _Optional[_Union[ProactiveAction.Actionable, _Mapping]] = ..., status: _Optional[_Union[ProactiveAction.Status, str]] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., app_uuids: _Optional[_Iterable[str]] = ..., prompt_for_subagent: _Optional[str] = ...) -> None: ...

class ApproveProactiveActionRequest(_message.Message):
    __slots__ = ("entry_id", "user_action", "spin_into_task", "override_app_uuids")
    ENTRY_ID_FIELD_NUMBER: _ClassVar[int]
    USER_ACTION_FIELD_NUMBER: _ClassVar[int]
    SPIN_INTO_TASK_FIELD_NUMBER: _ClassVar[int]
    OVERRIDE_APP_UUIDS_FIELD_NUMBER: _ClassVar[int]
    entry_id: int
    user_action: ProactiveAction.Actionable
    spin_into_task: bool
    override_app_uuids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, entry_id: _Optional[int] = ..., user_action: _Optional[_Union[ProactiveAction.Actionable, _Mapping]] = ..., spin_into_task: bool = ..., override_app_uuids: _Optional[_Iterable[str]] = ...) -> None: ...
