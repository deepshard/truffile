...
class NewTask(_message.Message):
    __slots__ = ("user_message", "app_uuids", "defer_start")
    ...
    defer_start: bool
    def __init__(self, user_message: _Optional[_Union[_task_user_response_pb2_1.UserMessage, _Mapping]] = ..., app_uuids: _Optional[_Iterable[str]] = ..., defer_start: bool = ...) -> None: ...
...
class TaskRenameRequest(_message.Message):
    __slots__ = ("task_id", "new_name")
    TASK_ID_FIELD_NUMBER: _ClassVar[int]
    NEW_NAME_FIELD_NUMBER: _ClassVar[int]
    task_id: str
    new_name: str
    def __init__(self, task_id: _Optional[str] = ..., new_name: _Optional[str] = ...) -> None: ...

class TaskRenameResponse(_message.Message):
    __slots__ = ("task_id", "new_name")
    TASK_ID_FIELD_NUMBER: _ClassVar[int]
    NEW_NAME_FIELD_NUMBER: _ClassVar[int]
    task_id: str
