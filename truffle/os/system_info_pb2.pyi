...
class SystemInfo(_message.Message):
    __slots__ = ("system_type", "firmware_version", "current_mode", "hardware_info")
    ...
    current_mode: _system_mode_pb2.SystemMode
    hardware_info: _hardware_info_pb2.HardwareInfo
    def __init__(self, system_type: _Optional[_Union[SystemInfo.TruffleType, str]] = ..., firmware_version: _Optional[_Union[FirmwareVersion, _Mapping]] = ..., current_mode: _Optional[_Union[_system_mode_pb2.SystemMode, str]] = ..., hardware_info: _Optional[_Union[_hardware_info_pb2.HardwareInfo, _Mapping]] = ...) -> None: ...
...
class SystemGetIDResponse(_message.Message):
    __slots__ = ("truffle_id", "serial_number", "current_mode")
    ...
    serial_number: str
    current_mode: _system_mode_pb2.SystemMode
    def __init__(self, truffle_id: _Optional[str] = ..., serial_number: _Optional[str] = ..., current_mode: _Optional[_Union[_system_mode_pb2.SystemMode, str]] = ...) -> None: ...
