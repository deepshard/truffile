...
class TaskInfo(_message.Message):
    __slots__ = ("run_state", "app_uuids", "task_title", "options", "created", "last_updated", "access_uri", "queued_user_responses")
    ...
    QUEUED_USER_RESPONSES_FIELD_NUMBER: _ClassVar[int]
    ...
    access_uri: str
    queued_user_responses: _containers.RepeatedCompositeFieldContainer[_task_user_response_pb2.QueuedUserResponse]
    def __init__(self, run_state: _Optional[_Union[TaskInfo.TaskRunState, str]] = ..., app_uuids: _Optional[_Iterable[str]] = ..., task_title: _Optional[str] = ..., options: _Optional[_Union[_task_options_pb2.TaskOptions, _Mapping]] = ..., created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., last_updated: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., access_uri: _Optional[str] = ..., queued_user_responses: _Optional[_Iterable[_Union[_task_user_response_pb2.QueuedUserResponse, _Mapping]]] = ...) -> None: ...
