...
class LoginNewSessionRequest(_message.Message):
    __slots__ = ("user_id", "password", "metadata")
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    password: str
    metadata: _client_metadata_pb2.ClientMetadata
    def __init__(self, user_id: _Optional[str] = ..., password: _Optional[str] = ..., metadata: _Optional[_Union[_client_metadata_pb2.ClientMetadata, _Mapping]] = ...) -> None: ...
