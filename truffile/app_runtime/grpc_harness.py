...
@dataclass(slots=True)
class FakeForegroundMcp:
    address: str = "10.22.0.99"
    port: int = 8000
    path: str = "/mcp"
...
class FakeAppRuntimeServicer:
    def __init__(self) -> None:
        ...
        self._pb2: Any = None
        self.fg_mcp: FakeForegroundMcp = FakeForegroundMcp()
        self.fg_mcp_acquire_calls: int = 0
        self.fg_mcp_refresh_calls: int = 0
        self.fg_mcp_release_calls: int = 0
    ...
    def AcquireForegroundMcp(self, request: Any, context: Any) -> Any:
        pb2 = self._ensure_pb2()
        self.fg_mcp_acquire_calls += 1
        duration = request.lease_duration_seconds or 300
        resp = pb2.AppRuntimeAcquireForegroundMcpResponse()
        resp.mcp_server.address = self.fg_mcp.address
        resp.mcp_server.port = self.fg_mcp.port
        resp.mcp_server.path = self.fg_mcp.path
        resp.lease_duration_seconds = duration
        return resp

    def RefreshForegroundMcp(self, request: Any, context: Any) -> Any:
        pb2 = self._ensure_pb2()
        self.fg_mcp_refresh_calls += 1
        duration = request.lease_duration_seconds or 300
        return pb2.AppRuntimeRefreshForegroundMcpResponse(lease_duration_seconds=duration)

    def ReleaseForegroundMcp(self, request: Any, context: Any) -> Any:
        pb2 = self._ensure_pb2()
        self.fg_mcp_release_calls += 1
        return pb2.AppRuntimeReleaseForegroundMcpResponse()
